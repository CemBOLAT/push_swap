...
//				-----cases-----
int		ft_case_rrarrb(t_list *stack_a, t_list *stack_b, int nbr, int s);
int		ft_case_rarb(t_list *a, t_list *b, int nbr, int s);
int		ft_case_rarrb(t_list *a, t_list *b, int nbr, int s);
int		ft_case_rrarb(t_list *a, t_list *b, int nbr, int s);
//---------------------cases end-------------------------
//				-----applies-----
